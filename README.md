...
### 第四步:第一个 feature 跑完，立刻 replanning

新项目里步骤 6 是"按需"，老项目里**第一轮 replanning 是必做**——反推出来的宪法第一版一定有偏差，跑完一个 feature 才看得出来要修哪儿。
